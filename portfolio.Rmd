...
AKAP9 protein plays an important role in centrosome duplication, cell cycle progression and maintenance of cell membrane integrity, alterations of which contribute to tumorigenesis. 

<em>**CACNA2D3**</em>
:encoding Calcium channel, voltage-dependent, alpha 2/delta subunit 3.
a potential tumor suppressor function in multiple tumor types
...
PTEN protein is negative regulators of the PI3-kinase pathway, which regulates growth, survival, and proliferation. These key signaling components(PI3K, PTEN) are two of the most frequently mutated proteins in human cancers, resulting in unregulated activation of PI3K signaling and providing irrefutable genetic evidence of the central role of this pathway in tumorigenesis. PTEN regulates PI3K signaling by dephosphorylating the lipid signaling intermediate PIP3.
...
PTEN은 유명한 tumor suppressor gene으로, DNA methylation 등의 이유로 PTEN에 mutation이 일어나게 되면 PI3K pathway의 negative feedback이 중단되어 tumor의 성장을 돕는다.
...
즉, tumorigenesis에 영향을 줄 만큼 `HR_gene`이 전반적인 대사 과정에 있어 중요한 역할을 하고 있기에 ASD뿐만 아니라 여러 질병에서 mutation을 나타낼 가능성이 있어서 `HR_gene`가 ASD에만 특이적인 ASD associated gene으로 보기에는 어렵다는 것이다.  
